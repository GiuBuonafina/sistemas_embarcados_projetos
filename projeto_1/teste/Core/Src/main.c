...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define PWM_FREQUENCY_HZ    4   // Hz
#define DUTY_CYCLE_PERCENT   50   // 0 a 100
/* USER CODE END PD */
